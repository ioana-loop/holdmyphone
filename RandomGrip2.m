...
% -------- GRIP 2 DATA FOR ALL 90 SUBJECTS ---------
...
patch('Vertices', my_vertices, 'Faces', my_faces, 'FaceColor', 'y', 'FaceAlpha', .2);

legend('Thumb', 'FInger 1', 'Finger 2', 'FInger 3', 'FInger 4', 'Phone')
